...
Params=($@)
mainClass=${Params[0]}
confProperties=${Params[1]}
logFile=../log/${Params[2]}
appName=${Params[3]}
Length=${#Params[@]}
args=${Params[@]:4:Length-1}



load_properties ../conf/${confProperties}
...
spark_cassandra_connection_host=$(getSparkProp $mainClass "spark.cassandra.connection.host")
...
spark_sql_hive_convertMetastoreParquet=$(getSparkProp $mainClass "spark.sql.hive.convertMetastoreParquet")


dependenceDir=/data/apps/azkaban/ai/searchrecommend/test
...
${spark_home}/bin/spark-submit -v \
 ...
 --jars ${jar_files} \
 --files /opt/spark2/conf/hive-site.xml \
 ...
 --conf spark.sql.hive.convertMetastoreParquet=${spark_sql_hive_convertMetastoreParquet} \
